...
?>
  ...
  <div class="form-group">
    <input style="width: 300px;" type="text" class="form-control" value="<?php echo $hasil['id_barang']; ?>" name="nama_lengkap" readonly>
  </div>
  <div class="form-group">
    <input style="width: 300px;" type="text" class="form-control" value="<?php echo $hasil['nama_barang']; ?>" name="nama" required>
  </div>
  <label class="col-sm-2 col-form-label" style="color:white;">Tanggal</label>
  <div class="form-group">
    <input style="width: 300px;" type="date" class="form-control" value="<?php echo $hasil['tgl']; ?>" name="tgl" required>
  </div>
  <div class="form-group">
    <input style="width: 300px;" type="text" class="form-control" value="<?php echo $hasil['harga_awal']; ?>" name="hargaAwal" required>
  </div>
  <div class="form-group">
    <textarea style="width: 300px;" class="form-control" id="exampleFormControlTextarea1" rows="3" name="desk"><?php echo $hasil['deskripsi']; ?></textarea>
  </div>
  <div class="container">
  <div class="row">
    <div class="col">
